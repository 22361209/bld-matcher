...
def register_routes(app) -> None:
    ...
    from . import admin, auth, home, inquiry, internal_api, material_drawings, materials, product_sync, products, purchase_contracts, shipment_notice, shipment_recognition

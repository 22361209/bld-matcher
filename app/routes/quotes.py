...
def _filters() -> dict[str, str]:
    return {
        ...
        "product_model": request.args.get("product_model", request.args.get("model", "")).strip(),
...
def register(app) -> None:
    ...
    def quotes():
        ...
        try:
            with connect(DB_PATH) as conn:
                ...
                latest = None
                if filters["customer_name"] and filters["product_model"]:
    ...
    def save_quote():
        ...
        return redirect(url_for("quotes", customer_name=request.form.get("customer_name", ""), product_model=request.form.get("product_model", "")) + "#quote-results")

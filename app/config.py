...
PRODUCT_IMAGE_MIGRATION_MARKER = DATA_DIR / ".product-image-migration-running"
...
PRODUCT_IMAGE_REQUEST_MAX_UPLOAD_MB = int(os.environ.get("PRODUCT_IMAGE_REQUEST_MAX_UPLOAD_MB", "160"))
MAX_CONTENT_LENGTH = max(MAX_UPLOAD_MB, PRODUCT_SYNC_MAX_UPLOAD_MB, PRODUCT_IMAGE_REQUEST_MAX_UPLOAD_MB) * 1024 * 1024

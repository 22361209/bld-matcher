...
class ProductInquiryModuleTest(unittest.TestCase):
    ...
    def test_catalog_import_requires_template_fields_and_imports_price_status_and_image(self) -> None:
        ...
        self.assertEqual(product["image_path"], "data_product_images/K-IMPORT-001_1.webp")
        saved_image = self.root / "data" / "product_images" / "K-IMPORT-001_1.webp"
        saved_thumb = self.root / "data" / "product_images" / "thumbs" / "K-IMPORT-001_1.webp"
        ...
        self.assertFalse((image_dir / "K-IMPORT-001.webp").exists())
